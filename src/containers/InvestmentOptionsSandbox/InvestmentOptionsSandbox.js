...
import s from './InvestmentOptionsSandbox.scss'
...
import {
  AgGridProvider,
  AgGridCustomizeColumnsModal,
} from '../../components/AgGrid'
import columns from './InvestmentOptionsSandboxColumns'
import { Menu } from '../../components/Menu'
import MenuItem from '../../components/Menu/MenuItem'
import MenuSpacer from '../../components/Menu/MenuSpacer'
import InvestmentOptionsSandboxGrid from './InvestmentOptionsSandboxGrid'
...
const query = gql`
  query InvestmentOptionsSandboxQuery(
...
class InvestmentOptionsSandbox extends Component {
  static propTypes = {
  ...
  onSelectionChanged = grid => {
    this.setState({
      selected: grid.api.getSelectedRows(),
    })
  }
    ...
    return (
      <FillContainer>
        <FlexColumnLayout>
          ...
          <AgGridProvider columns={columns} id="direct-investment-options-grid">
            <Query
              query={query}
              variables={{
                institutionLocationId:
...
export default InvestmentOptionsSandbox
